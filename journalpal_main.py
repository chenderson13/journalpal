...
#account key goes here. (used for cognitive services)
account_key = ''
google_places_key = ''
...
def Greeting(name):
    ...
    if(randomChoice ==1):
        return "Hello! My name is JournalPal." 
    elif(randomChoice ==2):
        return "Greetings!"
    elif(randomChoice == 3):
        return "Howdy!"
...
def HowAreYou(input):
    ...
    if(randomChoice == 1):
        ...
        return "I'm fine and dandy. Yourself?"
    elif(randomChoice == 3):
        return "I am fantastic.You?"
    elif(randomChoice == 4):
        return "I'm well, thank you. How about you?"
    elif(randomChoice == 5):
        return "I'm great, thanks. How about yourself?"
...
def Emotion(input, askedAboutDay=False):
    if(askedAboutDay==False):
        ...
        if(currentMood=="Happy"):
            ...
            return Stressed()
        elif(currentMood == "Playful"):
            return Playful(input)
